  ...
  <body>
    ...
    <main>
      <div class="container cnt-hide">
        <div class="a">
          <div class="slider"><a class="item" href="?view=trainwus">
              <h1>Entrená con <br><span>nosotros...</span></h1></a><a class="item" href="?view=tips">
              <h1>Tips <br><span>Consejos</span></h1></a></div>
        </div><a class="b" href="?view=taller">
          <p>TALLER<br><span class="line"></span><span>DE</span><span class="line"></span><br>TÉCNICA</p></a><a class="c" href="?view=mihistoria">
          <div class="wraper">
            <h1>MI</h1><span>HISTORIA</span>
          </div></a><a class="d" href="?view=Shop">
          <h1>SHOP <br></h1>
          <p>ACCESORIOS</p></a>
      </div>
      <div id="cnt_form">
